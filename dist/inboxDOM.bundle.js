    ...
    return {
        createTodo() {
            return {
                ...
                id: (0,uuid__WEBPACK_IMPORTED_MODULE_2__["default"])(),
                completed: false,
                date: (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(date.value.replace(/-/g, '/')), `MMM do y`,),
            };
        },
    }
}
...
function generateTodoDOM(todo) {
    ...
    markComplete.addEventListener('change', (e) => {
        ...
        _addProject_js__WEBPACK_IMPORTED_MODULE_1__.projects.filter((project) => {
            ...
            (0,_inbox_js__WEBPACK_IMPORTED_MODULE_0__.deleteTodo)(todo.id, project.id);
